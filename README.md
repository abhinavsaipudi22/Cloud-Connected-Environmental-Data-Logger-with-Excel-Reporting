...
LCD is initialized to display messages and sensor readings. UART0 is initialized for communication with the ESP-01 Wi-Fi module.\
...
GET /update?api_key=YOUR_API_KEY&field1=temperature&field2=temperature set point&field3=gas Uploads temp,gas,tempsetpoint data to ThingSpeak.
...
Temperature set point value is uploaded to Field 2.\
Gas Sensor value is uploaded to Field 3.\
...
Field 1 – Temperature Field 2 – Gas Sensor Status Field 3 - Temperature set point

# ThingSpeak Cloud Output
<img width="475" height="325" alt="image" src="https://github.com/user-attachments/assets/64076124-fff5-4d99-a93a-7ce9a7874466" />

<img width="475" height="325" alt="image" src="https://github.com/user-attachments/assets/7ab497ed-f9a2-4b85-b648-056608926766" />

<img width="475" height="325" alt="image" src="https://github.com/user-attachments/assets/3d16ee4d-4675-4662-a3cc-74e89af28f07" />

Hardware connections and Output\
<img width="1757" height="940" alt="image" src="https://github.com/user-attachments/assets/d9a3d7bd-217e-4167-a51b-aa72de2159a2" />

# Applications
Environmental Monitoring/ Smart Home Safety/ Gas Leakage Detection/ Industrial Monitoring/ IoT Data Logging/ Cloud-Based Sensor Monitoring
